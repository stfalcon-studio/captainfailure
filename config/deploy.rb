...
set :linked_files, fetch(:linked_files, []).push('config/application.rb', 'config/environment.rb', 'config/initializers/devise.rb', 'config/database.yml', 'config/secrets.yml', 'config/unicorn.rb')
